...
*HydraDX-wasm is part of the HydraDX (Hydration) open-source ecosystem. You can find more about HydraDX on the *[*official website*](https://hydration.net/)* and in the *[*documentation*](https://docs.hydration.net/)*. This repository specifically deals with off-chain math utilities.*
